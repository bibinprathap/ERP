...
@observer
class Report_InventoryReports extends Component {
    constructor(props) {
        super(props)
    }
    render() {
            ...
            <div>
                ...
                <Row>
                    ...
                    <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                      ...
                      <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                        <div className="thumbnail" style={{ border: '0px solid white' }}>
                            <button style={style_img} onClick={window.negativeitemsreport}>
                                <Col xs={3} sm={3} md={3} lg={3} xl={3}><img src={img_src} width='50px'  /> </Col>
                                <Col xs={9} sm={9} md={9} lg={9} xl={9} style={{ paddingTop: '3%' }}><div className='caption'>
                                    <a><p className='textCentre'>Negative items Sales</p></a>
                                </div>
                            </Col></button>
...
Report_InventoryReports.propTypes =
    {
...
export default asForm(Report_InventoryReports, "reportdetails")  