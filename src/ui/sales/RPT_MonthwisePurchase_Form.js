...
@observer
class RPT_MonthwisePurchase_Form extends Component 
{
    constructor (props) {
        super(props)
        this.state ={};
                        ...
                        <div className="panel-body"  style={{padding: 5+'px ' + 15+'px ' + 2+'px ' + 15+'px'}}>  
                           <Row>
                             ...
                             <Row>
                                ...
                                RPT_MonthwisePurchase_Form.propTypes = 
                                {
...
export default asForm(RPT_MonthwisePurchase_Form,"RPT_DailyOpOptions")