...
export default class RPT_DailyItemSalesLed extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    printReport (event) {
        ...
        var RefNo='PROC|' + constants.getprocedurename('SP_dailyitemsalesledger',constants.COMPANY) +  ';@dates|\'' + yyyymmdd + '\';@Br|\'' + constants.ERP_BRANCH + '\''
        var reportURL=constants.REPORTURL + '/ReportPrint.aspx?ReportCode=RPTDITEM_SLDG&RefNo=' + RefNo + '&heading=' + ddmmyyyy + '&subheading={BRANCH}&Company=' + constants.COMPANY
    ...
    viewReport (event) {
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getdailyitemsalesledger',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "itemcode", name: "Item Code", field: "itemcode", width: 110 });
                ...
                columns.push({ id: "cost", name: "Cost", field: "cost", width: 75,  groupTotalsFormatter: sumTotalsFormatter, formatter:numformatter } );
                columns.push({ id: "margin", name: "Margin", field: "margin", width: 75,  groupTotalsFormatter: sumTotalsFormatter, formatter:numformatter} );
                columns.push({ id: "customer", name: "Customer", field: "customer", width: 200 } );
                columns.push({ id: "salesman", name: "Salesman", field: "salesman", width: 65 } );
                columns.push({ id: "user", name: "User Name", field: "user", width: 65 } );
                columns.push({ id: "date_time", name: "Date Time", field: "date_time", width: 70 } );
    ...
    resetOptions={this.resetOptions} reportTitle='Daily Item Sales Ledger'/> }
