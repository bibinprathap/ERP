...
export default class RPT_CashSales extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    viewReport (event) {
        ...
        if(  constants.getFieldValue(this.RPT_DailyOpOptions.salesman) ) 
            loadrequest.parem3 =  constants.getFieldValue(this.RPT_DailyOpOptions.salesman)
       if(constants.getFieldValue(this.RPT_DailyOpOptions.salesman)) 
       ...
       if(constants.getFieldValue(this.RPT_DailyOpOptions.custsupno)) 
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getcashreport',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "br", name: "BR", field: "br", width: 30,cssClass: "cell-title" });
                ...
                columns.push({ id: "ref", name: "Phone No.", field: "ref", width: 110 } );
    ...
    resetOptions={this.resetOptions} reportTitle='Cash Sales Report'/> }
