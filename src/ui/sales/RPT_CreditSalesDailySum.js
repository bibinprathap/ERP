...
export default class RPT_CreditSalesDailySum extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    viewReport (event) {
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getcreditsalesdailysummary',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "docdate", name: "DATE", field: "docdate", width:100 , groupTotalsFormatter: sumTotalLabel });
    ...
    resetOptions={this.resetOptions} reportTitle='Date wise Credit Sales Summary'/> }
