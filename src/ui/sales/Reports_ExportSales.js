...
@observer
class Reports_ExportSales extends Component {
    constructor(props) {
        super(props)
    }
    render() {
                ...
                <Row>
                    ...
                    <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                        <div className="thumbnail" style={{ border: '0px solid white' }}>
                            <button style={style_img} onClick={window.exportsalesrpt}>
                                ...
                                <Col xs={9} sm={9} md={9} lg={9} xl={9} style={{ paddingTop: '3%' }}><div className='caption'>
                                    <a><p className='textCentre'>Export Sales</p></a>
                                </div>
                                </Col> 
                            </button>
                        </div>
                    ...
                    <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                        <div className="thumbnail" style={{ border: '0px solid white' }}>
                            <button style={style_img} onClick={window.exportinvprofit}>
                                 <Col xs={3} sm={3} md={3} lg={3} xl={3}><img src={img_src} width='50px'  /> </Col>
                                <Col xs={9} sm={9} md={9} lg={9} xl={9} style={{ paddingTop: '3%' }}><div className='caption'>
                                    <a><p className='textCentre'>Export Invoice Profit</p></a>
                                </div>
                                </Col>
                            </button>
                        </div>
...
export default asForm(Reports_ExportSales, "reportdetails")