...
@observer
class RPT_PendingItems_Form extends Component 
{
    constructor (props) {
                    ...
                    <div className="panel panel-primary" >
                        ...
                        <div className="panel-body"  style={{padding: 5+'px ' + 15+'px ' + 2+'px ' + 15+'px'}}>  
                           ...
                           <Col xs={1} sm={1} md={1} lg={1} xl={1}>
                                ...
                                <Col xs={3} sm={3} md={3} lg={3} xl={3}>
            	                   <InputSelect id="custsupname" name="custsupname" value={RPT_DailyOpOptions.custsupname} onChange={updateProperty} placeholder="Select Customer"   combotype={true}  loadOptions={this.getACC}/>
                                </Col>      
                            </Row>
                            <Row>
                                <Col xs={1} sm={1} md={1} lg={1} xl={1}>
                             ...
                             <Row>
                                ...
                                RPT_PendingItems_Form.propTypes = 
                                {
...
export default asForm(RPT_PendingItems_Form,"RPT_DailyOpOptions")