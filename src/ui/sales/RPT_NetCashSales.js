...
export default class RPT_NetCashSales extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    viewReport (event) {
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/netcashsales',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "DOCNO", name: "Inv. No.", field: "DOCNO", width: 60 ,  groupTotalsFormatter: sumTotalLabel   });
                ...
                columns.push({ id: "amount", name: "Net Amount", field: "amount",width: 90,   formatter:numformatter,  groupTotalsFormatter: sumTotalsFormatter, minWidth: 30 } );
                columns.push({ id: "rtnamount", name: "Return", field: "rtnamount",width: 90,   formatter:numformatter,  groupTotalsFormatter: sumTotalsFormatter, minWidth: 30 } );
                columns.push({ id: "netsales", name: "Net Sales", field: "netsales",width: 90,   formatter:numformatter,  groupTotalsFormatter: sumTotalsFormatter, minWidth: 30 } );
                columns.push({ id: "ref", name: "Phone No.", field: "ref", width: 120 } );
                columns.push({ id: "narration", name: "Customer", field: "narration", width: 200 } );
    ...
    resetOptions={this.resetOptions} reportTitle='Net Cash Sales Report'/> }
