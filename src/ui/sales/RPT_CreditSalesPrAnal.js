...
export default class RPT_CreditSalesPrAnal extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    viewReport (event) {
       ...
       if(constants.getFieldValue(this.RPT_DailyOpOptions.custsupno)) 
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getcreditsalespranal',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
    ...
    render () {
        ...
        <div>   
            ...
            {  <RPT_CashSales_Form RPT_DailyOpOptions={this.RPT_DailyOpOptions} 
                    ...
                    resetOptions={this.resetOptions} reportTitle='Credit Sales Profit Analysis'/> }
