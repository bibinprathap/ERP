...
export default class RPT_CreditSalesReturn extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    viewReport (event) {
       ...
       if(constants.getFieldValue(this.RPT_DailyOpOptions.custsupno)) 
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getcreditsalesretreport',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "src", name: "TRN", field: "src", width: 50 });
                ...
                columns.push({ id: "amount", name: "Amount", field: "amount",  groupTotalsFormatter: sumTotalsFormatter, width: 90, formatter:numformatter } );
                columns.push({ id: "ref", name: "Inv. No.", field: "ref", width: 70 } );
                columns.push({ id: "Customer", name: "Customer", field: "Customer", width: 250} );
    ...
    render () {
        ...
        <div>              
            {  <RPT_CashSales_Form RPT_DailyOpOptions={this.RPT_DailyOpOptions} 
                    ...
                    resetOptions={this.resetOptions} reportTitle='Credit Sales Return Report'/> }
</div>
        )
}
