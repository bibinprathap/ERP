...
@observer
class RPT_TB_MN_Form extends Component 
{
    constructor (props) {
        super(props)
        this.state ={};
        ...
        this.props.RPT_TBOptions.filtervalue=moment(currentdate).format("YYYY")
        this.props.RPT_TBOptions.custsupname= moment(currentdate).format("MM")
    }
    getMonths= (input) => {
        return fetch(constants.SERVICEURL + `/combo/getMonths/`, {
            method: 'POST', 
            headers: {
   ...
   getYears1= (input) => {
       return fetch(constants.SERVICEURL + `/combo/getyears1/`, {
                method: 'POST', 
                headers: {
                    'Content-Type': 'application/json'
                } 
                  ...
                  <div className="panel panel-primary" >
                        ...
                        <div className="panel-body"  style={{padding: 5+'px ' + 15+'px ' + 2+'px ' + 15+'px'}}>  
                           <Row>
                                ...
                                <Col xs={1} sm={1} md={1} lg={1} xl={1} style={{padding: 5+'px ' + 0+'px ' + 0+'px ' + 0+'px'}}>
                                ...
                                <Col xs={2} sm={2} md={2} lg={2} xl={2} style={{padding: 0+'px ' + 0+'px ' + 0+'px ' + 0+'px'}}>
                                    <InputSelect id="filtervalue" name="filtervalue" value={RPT_TBOptions.filtervalue} onChange={updateProperty} placeholder="Select Year" combotype={true}  loadOptions={this.getYears1}/>
                                </Col>  
                                <Col xs={1} sm={1} md={1} lg={1} xl={1} style={{padding: 5+'px ' + 0+'px ' + 0+'px ' + 15+'px'}}>
                                    Month
                                </Col>
                                <Col xs={2} sm={2} md={2} lg={2} xl={2} style={{padding: 5+'px ' + 0+'px ' + 0+'px ' + 0+'px'}}>
                                    <InputSelect id="custsupname" name="custsupname" value={RPT_TBOptions.custsupname} onChange={updateProperty} placeholder="Select Month" combotype={true}  loadOptions={this.getMonths}/>
                                </Col> 
                                <Col xs={1} sm={1} md={1} lg={1} xl={1} style={{padding: 5+'px ' + 0+'px ' + 0+'px ' + 15+'px'}}>
                                    Branch
                                </Col>
        ...
        (
            {
                ...
                custsupname: PropTypes.string,
                filtervalue: PropTypes.string,
                branch: PropTypes.string
            }
        )
    }
export default asForm(RPT_TB_MN_Form,"RPT_TBOptions")