...
export default class RPT_UnderCostSalesLedger extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    viewReport (event) {
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getundercostsalesledger',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "docdate", name: "Date", field: "docdate", width: 80,cssClass: "cell-title" });
                columns.push({ id: "br", name: "Branch", field: "br", width: 50,cssClass: "cell-title" });
                columns.push({ id: "trn", name: "TRN", field: "trn", width: 50,cssClass: "cell-title" });
                columns.push({ id: "invno", name: "Inv. No.", field: "invno", width:60});
                columns.push({ id: "partno", name: "Part No.", field: "partno", width: 110});
                columns.push({ id: "brand", name: "Brand", field: "brand", width: 40 });
                columns.push({ id: "origin", name: "Origin", field: "origin", width: 40} );
                columns.push({ id: "descr", name: "Description", field: "descr", width: 200 } );
                columns.push({ id: "qty", name: "Qty", field: "qty", width: 60 , formatter:numformatter } );
                columns.push({ id: "unitprice", name: "Unit Price", field: "unitprice", width: 85, formatter:numformatter} );
                columns.push({ id: "costp", name: "Cost", field: "costp", width: 85, formatter:numformatter} );
                columns.push({ id: "sman", name: "Salesman", field: "sman", width: 90} );
                columns.push({ id: "username", name: "User Name", field: "username", width: 90} );
    ...
    resetOptions={this.resetOptions} reportTitle='Under Cost Sales Ledger'/> }
