...
@observer
class RPT_TB_MV_Form extends Component 
{
    constructor (props) {
        super(props)
        this.state ={};
                        ...
                        <div className="panel-body"  style={{padding: 5+'px ' + 15+'px ' + 2+'px ' + 15+'px'}}>  
                           <Row>
                                ...
                                <Col xs={2} sm={2} md={2} lg={2} xl={2} style={{padding: 0+'px ' + 0+'px ' + 0+'px ' + 0+'px'}}>
            	                    <InputDate onChange={updateProperty} value={RPT_TBOptions.fromdate} id="fromdate" name="fromdate" />
                                </Col>  
                                <Col xs={1} sm={1} md={1} lg={1} xl={1} style={{padding: 5+'px ' + 0+'px ' + 0+'px ' + 15+'px'}}>
                                    To Date
                                </Col>
...
export default asForm(RPT_TB_MV_Form,"RPT_TBOptions")