...
export default class RPT_CreditSalesMonthlySum extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    viewReport (event) {
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getcreditsalesmonthlysummary',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "br", name: "Branch", field: "br", width: 80,cssClass: "cell-title" });
                columns.push({ id: "yyyymm", name: "Month", field: "yyyymm", width:100, formatter: monthformatter, groupTotalsFormatter: sumTotalLabel });
                columns.push({ id: "TSRC", name: "Type", field: "TSRC", width: 100, formatter: doctypeformmatter });
                columns.push({ id: "gross", name: "Gross Sales", field: "gross", width: 90 ,  groupTotalsFormatter: sumTotalsFormatter, formatter:numformatter});
                columns.push({ id: "disc", name: "Discount", field: "disc", width: 90 ,  groupTotalsFormatter: sumTotalsFormatter, formatter:numformatter} );
                columns.push({ id: "amt", name: "Net Sales", field: "amt",  groupTotalsFormatter: sumTotalsFormatter, width: 90 , formatter:numformatter} );
                columns.push({ id: "cost", name: "Cost", field: "cost", width: 90,  groupTotalsFormatter: sumTotalsFormatter, formatter:numformatter } );
                columns.push({ id: "margin", name: "Margin", field: "margin", width: 90,  groupTotalsFormatter: sumTotalsFormatter, formatter:numformatter } );
                ...
                function monthformatter(row, cell, value, columnDef, dataContext){
                    ...
                    mm=Number(yyyymm.substr(4,2));
                    yyyymmm=yyyy + ' ' + constants.monthshortname(mm)
                    return yyyymmm
                }
    ...
    resetOptions={this.resetOptions} reportTitle='Month wise Credit Sales Summary'/> }
