...
export default class RPT_CreditSales extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    printReport (event) {
        ...
        var RefNo='PROC|' + constants.getprocedurename('procgetcreditsalesreport',constants.COMPANY) +   ';@fromdates|\'' + yyyymmddf + '\';@todates|\'' + yyyymmddt + '\';@br|\'' + constants.getFieldValue( this.RPT_DailyOpOptions.branch) + '\';@sman|\'' + constants.getFieldValue(this.RPT_DailyOpOptions.salesman) + '\';@custorsup|\'' + constants.getFieldValue(this.RPT_DailyOpOptions.custsupno) + '\'';
        var reportURL=constants.DSREPORTURL + '/ReportPrint.aspx?ReportCode=RPTCRSALES&RefNo=' + RefNo + '&heading=' + ddmmyyyyfrom  +' - ' + ddmmyyyyto + '&subheading={BRANCH}&subheading1=\'' + mSub1 + '\'&Company=' + constants.COMPANY;
    ...
    viewReport (event) {
       ...
       if(constants.getFieldValue(this.RPT_DailyOpOptions.custsupno)) 
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getcreditsalesreport',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "ref", name: "Reference", field: "ref", width: 130 } );
    ...
    render () {
        ...
        <div>   
            ...
            {  <RPT_CashSales_Form RPT_DailyOpOptions={this.RPT_DailyOpOptions} 
                    ...
                    resetOptions={this.resetOptions} reportTitle='Credit Sales Report'/> }
