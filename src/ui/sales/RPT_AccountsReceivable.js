...
export default class RPT_AccountsReceivable extends React.Component {
    ...
    printReport(event) {
        ...
        var RefNo = 'PROC|' + constants.getprocedurename('SP_GetAccountsReceivable', constants.COMPANY) + ';@dt|\'' + yyyymmdd + '\';@glac|\'' + glac + '\''
        var reportURL = constants.REPORTURL + '/ReportPrint.aspx?ReportCode=RPTAR&RefNo=' + RefNo + '&heading=' + ddmmyyyy + '&subheading=' + glac + '&Company=' + constants.COMPANY
    ...
    viewReport(event) {
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL + '/accountsreceivable',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "acno", name: "Cust A/c", field: "acno", width: 80, cssClass: "cell-title" });
                columns.push({ id: "acname", name: "Customer Name", field: "acname", width: 250, formatter: sumTotalLabel });
                ...
                columns.push({ id: "tel", name: "Phone No.", field: "tel", minWidth: 200 });
    ...
    render() {
        return (
            <div>
                ...
                {<RPT_ARAP_Form RPT_DailyOpOptions={this.RPT_DailyOpOptions} getarapgroupsname='getargroups'
                    viewReport={this.viewReport} printReport={this.printReport}
                    resetOptions={this.resetOptions} reportTitle='Account Receivable Report' />}
