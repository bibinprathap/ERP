...
@observer
class CustomerComplaint_SubForm extends Component {
    constructor(props) {
        super(props)
            ...
            <div className="container-fluid">
                <div className="panel panel-primary"  >
                    <div className="panel-body" style={{ padding: 5 + 'px ' + 15 + 'px ' + 2 + 'px ' + 15 + 'px' }}>
                        ...
                        <Row>
                            <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: 2 + 'px ',width:40 +'%',height:60 + 'px'}}>
                                <InputField id="partno" className="form-control noenter" tabIndex="3"
                                name="partno" value={SalesItem.partno} onChange={updateProperty} placeholder="Complaint" />
                            </Col>
...
CustomerComplaint_SubForm.propTypes =
    {
...
export default asForm(CustomerComplaint_SubForm, 'Customercomplaint')
