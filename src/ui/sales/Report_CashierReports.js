...
@observer
class Report_CashierReports extends Component {
    constructor(props) {
        super(props)
    }
    render() {
...
Report_CashierReports.propTypes =
    {
...
export default asForm(Report_CashierReports, "reportdetails")