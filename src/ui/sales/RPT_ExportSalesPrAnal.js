...
export default class RPT_ExportSalesPrAnal extends React.Component 
{
    constructor (props) {
        super(props);
    ...
    viewReport (event) {
       ...
       if(constants.getFieldValue(this.RPT_DailyOpOptions.custsupno)) 
        ...
        window.openModal(); $.ajax({
            url: constants.SERVICEURL +'/getexportsalesprofitanal',
            type: 'POST',
            dataType: 'json',
            data: loadrequest,
            success: function (respoce, textStatus, xhr) {  window.closeModal();
                ...
                columns.push({ id: "gross", name: "Gross", field: "gross", width: 90,  groupTotalsFormatter: sumTotalsFormatter , formatter:numformatter});
                ...
                columns.push({ id: "cos", name: "Cost", field: "cos",  groupTotalsFormatter: sumTotalsFormatter, width: 90 , formatter:numformatter} );
                columns.push({ id: "margin", name: "Margin", field: "margin",  groupTotalsFormatter: sumTotalsFormatter, width: 90, formatter:numformatter } );
                columns.push({ id: "per", name: "Per %", field: "per",  groupTotalsFormatter: sumTotalsFormatter, width: 90 , formatter:numformatter} );
                ...
                setTimeout(function(){
                    ...
                    dataView.setGrouping({
                        ...
                        aggregators: [
                          ...
                          new Slick.Data.Aggregators.Sum("cos"),
                          new Slick.Data.Aggregators.Sum("margin"),
                          new Slick.Data.Aggregators.Sum("per")
                        ],
    ...
    render () {
        ...
        <div>   
            ...
            {  <RPT_CashSales_Form RPT_DailyOpOptions={this.RPT_DailyOpOptions} 
                    ...
                    resetOptions={this.resetOptions} reportTitle='Export Invoice Profit Analysis'/> }
