...
@observer
class RPT_Purchase_Form extends Component 
{
    constructor (props) {
        super(props)
        this.state ={};
    ...
    getBrands = (input) => {
        ...
        render () {
            ...
            const Options  =[{value:'PO',label:'Purchase Order'},
            {value:'DN',label:'Purchase Return'},
            {value:'PR',label:'Purchase Invoice'}];
            return(
                        ...
                        <div className="panel-body"  style={{padding: 5+'px ' + 15+'px ' + 2+'px ' + 15+'px'}}>  
                           <Row>
                            ...
                            <Col xs={1} sm={1} md={1} lg={1} xl={1}>
                                ...
                                <InputSelect id="acname" name="acname" 
                                    value={RPT_DailyOpOptions.acname} onChange={updateProperty}
...
export default asForm(RPT_Purchase_Form,"RPT_DailyOpOptions")