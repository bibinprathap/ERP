...
@observer
class Report_SalesAnalysis extends Component {
    constructor(props) {
        super(props)
    }
    render() {
...
Report_SalesAnalysis.propTypes =
    {
...
export default asForm(Report_SalesAnalysis, "reportdetails")