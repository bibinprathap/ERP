...
@observer
class Report_PurchaseReport extends Component {
    constructor(props) {
        super(props)
    }
    render() {
                ...
                <Row>
                    ...
                    <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                        <div className="thumbnail" style={{ border: '0px solid white' }}>
                            <button style={style_img} onClick={window.purchasereport}>
                                ...
                                <Col xs={9} sm={9} md={9} lg={9} xl={9} style={{ paddingTop: '3%' }}> <div className='caption'> 
                                    <a><p className='textCentre'>Purchase</p></a>
                                </div>
                             </Col></button>
                        </div>
                    </Col>
                            ...
                            <button style={style_img} onClick={window.purchasereport}>
                                ...
                                <Col xs={9} sm={9} md={9} lg={9} xl={9}
                                 style={{ paddingTop: '3%' }}> <div className='caption'>  
                                    <a><p className='textCentre'>Purchase Return</p></a>
                                </div>
                             </Col></button>
                        </div>
                    </Col>
                    <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                        <div className="thumbnail" style={{ border: '0px solid white' }}>
                            <button style={style_img}  onClick={window.netpurchasereport}>
                                 <Col xs={3} sm={3} md={3} lg={3} xl={3}><img src={img_src} width='50px'  /> </Col>
                                <Col xs={9} sm={9} md={9} lg={9} xl={9} style={{ paddingTop: '3%' }}> <div className='caption'>  
                                    <a><p className='textCentre'>Net Purchase</p></a>
                                </div>
                             </Col></button>
                        </div>
                    </Col>
                    <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                        <div className="thumbnail" style={{ border: '0px solid white' }}>
                            <button style={style_img} onClick={window.purchasesalereport}>
                                 <Col xs={3} sm={3} md={3} lg={3} xl={3}><img src={img_src} width='50px'  /> </Col>
                                <Col xs={9} sm={9} md={9} lg={9} xl={9} style={{ paddingTop: '3%' }}> <div className='caption'>  
                                    <a><p className='textCentre'>Purchase Sales Profit Analysis</p></a>
                                </div>
                             </Col></button>
                        </div>
                    </Col>
                    <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                        <div className="thumbnail" style={{ border: '0px solid white' }}>
                            <button style={style_img} onClick={window.datewisepurchasereport}>
                                 <Col xs={3} sm={3} md={3} lg={3} xl={3}><img src={img_src} width='50px'  /> </Col>
                                <Col xs={9} sm={9} md={9} lg={9} xl={9} style={{ paddingTop: '3%' }}> <div className='caption'> 
                                    <a><p className='textCentre'>Date-wise Purchase Summary</p></a>
                                </div>
                             </Col></button>
                        </div>
                    </Col>
                    <Col xs={3} sm={3} md={3} lg={3} xl={3} style={{ padding: '0' }}>
                        <div className="thumbnail" style={{ border: '0px solid white' }}>
                            <button style={style_img} onClick={window.monthwisepurchasereport}>
                                 <Col xs={3} sm={3} md={3} lg={3} xl={3}><img src={img_src} width='50px'  /> </Col>
                                <Col xs={9} sm={9} md={9} lg={9} xl={9} style={{ paddingTop: '3%' }}> <div className='caption'> 
                                    <a><p className='textCentre'>Month-wise Purchase Summary</p></a>
                                </div>
                             </Col></button>
                        </div>
                    </Col>
...
Report_PurchaseReport.propTypes =
    {
...
export default asForm(Report_PurchaseReport, "reportdetails")